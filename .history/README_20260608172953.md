...
Bu proje, Nesne Yönelimli Programlama (OOP) prensiplerini uygulayarak bir araç kiralama firmasının günlük operasyonlarını dijital ortamda yöneten bir otomasyonu sistemini simüle etmektedir. 
...
| Ad Soyad | Öğrenci No | Katkı Alanı | Oran |
|----------|-----------|------------|------|
| **Ömer Faruk Süleyman** | 0414240009 | Arac.h/cpp, AltSiniflar.h/cpp (Araba, Kamyonet, Motosiklet) | %33 |
| **Samet Baturay** | 0414230028 | Musteri.h/cpp, KiralamaKaydi, KiralamaHatasi | %33 |
| **Kerem Berk Yağcı** | 0414240014 | YoneticiSistemi.h/cpp, main.cpp, Proje Organizasyonu | %33 |
